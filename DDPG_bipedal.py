...
class actor(object):
    def __init__(self, n_actions, input_dims, learning_rate, name, sess, fc1_dims, fc2_dims, action_bound,
                 batch_size=64):
...
agent = Agent(alpha=0.0001, beta=0.001, input_dims=[24], tau=0.001, env=env,
              batch_size=64, layer_1_size=800, layer_2_size=600, n_actions=4)
np.random.seed(0)
score_history = []
